...
SRC_MIN = $(patsubst %.c, $(SRC)/Minishell/%.c, handlers.c ft_type.c env_list.c fds.c builtin.c free.c ft_cd.c ft_echo.c ft_env_new.c ft_pwd.c main.c shell.c exec.c redir.c job.c jobs_list.c exec2.c JobTesting/execute.c JobTesting/job2.c JobTesting/ft_jobs.c JobTesting/ft_fg.c JobTesting/ft_bg.c)
...
SRC_HISTORY= $(patsubst %.c, $(SRC)/history/%.c, history.c)
