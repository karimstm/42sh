...
SRC_MIN = $(patsubst %.c, $(SRC)/Minishell/%.c, system.c pre_parse.c handlers.c ft_type.c env_list.c fds.c builtin.c free.c ft_cd.c ft_echo.c ft_env_new.c ft_pwd.c main.c shell.c exec.c redir.c exec2.c jobs/jobs_list.c Jobs/job.c Jobs/execute.c Jobs/job2.c Jobs/ft_jobs.c Jobs/ft_fg.c Jobs/ft_bg.c)
